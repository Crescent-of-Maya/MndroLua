...
public class CrashHandler implements UncaughtExceptionHandler
{
	...
	private boolean handleException(Throwable ex)
	{
		...
		//保存日志文件 
		saveCrashInfo2File(ex, mContext.getExternalFilesDir("crash"));
		return false; // 如果返回true的话就会一直卡白屏 还是用默认处理方式
	}
	 ...
	 */
	private String saveCrashInfo2File(Throwable ex, File dir)
	{
