...
public class LanguageLua extends Language {
	...
	private final static String keywordTarget ="and|break|case|continue|default|do|else|elseif|end|false|for|function|goto|if|in|local|nil|not|or|repeat|return|switch|then|true|until|while|lambda";
	private final static String globalTarget="__type|__add|__band|__bnot|__bor|__bxor|__call|__concat|__div|__eq|__idiv|__index|__le|__len|__lt|__mod|__mul|__newindex|__pow|__shl|__shr|__sub|__tostring|__unm|_ENV|_G|assert|collectgarbage|dofile|error|findtable|getmetatable|ipairs|load|loadfile|loadstring|module|next|pairs|pcall|print|rawequal|rawget|rawlen|rawset|require|select|self|setmetatable|tointeger|tonumber|tostring|type|unpack|xpcall";
	...
	private final static String package_luajava = "override|astable|bindClass|clear|coding|createArray|createProxy|getContext|instanceof|loadLib|loaded|luapath|new|newInstance|package|tostring";
	...
	private final static String extFunctionTarget="this|activity|call|compile|dump|each|enum|import|loadbitmap|loadPackage|loadlayout|loadmenu|service|set|task|thread|timer";
